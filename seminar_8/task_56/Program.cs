...
int MinimumRow(int[] rowSumArray)
{
...
int[] rowSum = FindRowSum(newMatrix);
int minRow = MinimumRow(rowSum);
Console.WriteLine($"Минимальная сумма элементов в строке: {minRow}");